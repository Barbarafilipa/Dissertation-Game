...
Ei, estás pronto para o teste? #portrait:speech_right_lvl4_friend #speaker:Friend #animation:Child_serious #animation:Friend_happy #hide:Ansiedade #audio:friend_lvl4_01
...
+ [Não, vou dizer à professora que estou doente para não fazer. $audio:child_lvl4_02]
    ...
    Fazer o teste agora pode ser difícil, mas depois não precisas de te preocupar mais com ele. #animation:Friend_smiling #audio:friend_lvl4_03
...
+ [Estou ansioso, mas vou tentar fazer o teste. $audio:child_lvl4_03]
    ...
    Mas às vezes não podemos evitar que isso aconteça. #audio:friend_lvl4_05
...
+ [Eu estudei muito, então vai correr bem. $audio:child_lvl4_04]
    ...
    Um teste é apenas uma avaliação, se não correr bem, depois podes melhorar nos próximos. #animation:Friend_smiling #audio:friend_lvl4_08
    -> minigame_cano_dos_pensamentos
...
+ [Vou fechar os olhos e respirar devagar. $audio:child_lvl4_09]
    ...
    Imagina que tens uma flor na mão e uma vela na outra. #show:Flower #show:Candle #audio:teacher_lvl4_06
    
    Agora cheira a flor bem devagar pelo nariz... #hide:Candle #show:Inspirar #hide:Expirar #audio:teacher_lvl4_07
    
    E agora sopra a vela com calma pela boca... #hide:Flower #show:Candle #animation:Child_happy #animation:Teacher_happy #hide:Inspirar #show:Expirar #audio:teacher_lvl4_08
    
    Outra vez! Cheira a flor... #show:Flower #hide:Candle #animation:Teacher_smiling #show:Inspirar #hide:Expirar #audio:teacher_lvl4_09
    
    Sopra a vela... #show:Candle #hide:Flower #animation:Child_happy #animation:Teacher_happy #hide:Inspirar #show:Expirar #audio:teacher_lvl4_10
    
    Muito bem! Quando respiras assim o teu corpo acalma e a ansiedade começa a ir embora. #animation:Child_veryHappy #hide:Candle #animation:Teacher_veryHappy #hide:Inspirar #hide:Expirar #sticker:RespiracaoTranquila #show:RespiracaoTranquila #audio:teacher_lvl4_11
